...
# ВАЖНО: Только необходимые зависимости. Torch и Transformers включены.
...
# ОСТАВЛЯЕМ ТОЛЬКО arm64-v8a. Это спасет билд от вылета по памяти!
android.archs = arm64-v8a

# Оптимизация памяти для тяжелых нейросетей
